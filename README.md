...
Please see:
 ...
 [LICENSE.AGPL](https://github.com/imgly/imgly-sdk-android/blob/master/LICENSE.AGPL) for NON-PROPIETARY usage. <br/>
...
dependencies {
    ...
    compile 'ly.img.android:photo-editor-sdk:0.9.5'
    ...
}
```
