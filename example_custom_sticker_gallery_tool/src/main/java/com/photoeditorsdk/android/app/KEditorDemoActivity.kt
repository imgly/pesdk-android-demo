...
import com.photoeditorsdk.android.app.custom.CustomStickerOptionTool
import com.photoeditorsdk.android.app.custom.CustomStickerTool
...
class KEditorDemoActivity : Activity(), PermissionRequest.Response {
    ...
    companion object {
        ...
        init {
            UiState.addPanel(PanelData(CustomStickerTool.TOOL_ID, CustomStickerTool::class.java))
            UiState.addPanel(PanelData(CustomStickerOptionTool.TOOL_ID, CustomStickerOptionTool::class.java))
            UiState.addTitle(TitleData(CustomStickerOptionTool.TOOL_ID, R.string.pesdk_sticker_title_name))
        }
    }
    ...
    private fun createPesdkSettingsList() =
      PhotoEditorSettingsList()
        ...
        .configure<UiConfigSticker> {
            ...
            it.toolList.add(ToolItem(CustomStickerTool.TOOL_ID, "Custom", ImageSource.create(R.drawable.imgly_filter_preview_photo)))
